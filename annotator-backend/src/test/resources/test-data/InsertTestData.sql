...
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Twan', '00000000-0000-0000-0000-000000000111', 'x@mail.domain', 'X.Developer@mail.domain', 'developer'); --1 
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Peter', '00000000-0000-0000-0000-000000000112', 'y@mail.domain', 'Y.Developer@mail.domain', 'developer'); -- 2
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Alice', '00000000-0000-0000-0000-000000000113', 'alice@mmail.domain', 'Alice.X@mail.domain', 'admin'); -- 3
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Eric', '00000000-0000-0000-0000-000000000114', 'eric@mail.domain', 'Eric.Y@mail.domain', 'developer'); -- 4
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Daan', '00000000-0000-0000-0000-000000000115', 'z@mail.domain', 'Daan.Z@mail.domain', 'developer'); --5 
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Menzo', '00000000-0000-0000-0000-000000000116', 'u@mail.domain', 'Menzo.U@mail.domain', 'developer'); -- 6
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Przemek', '00000000-0000-0000-0000-000000000117', 'w@mail.domain', 'Przemek.W@mail.domain', 'principal'); -- 7
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Stephanie', '00000000-0000-0000-0000-000000000118', 's@mail.se', 'Stephanie.s@mail.se', 'developer'); -- 8
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Olof', '00000000-0000-0000-0000-000000000119', 'o@mail.se', 'olof.o@mail.se', 'developer'); -- 9
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Willem', '00000000-0000-0000-0000-000000000220', 'wil@mail.domain', 'Willem.Wil@mail.domain', 'developer'); -- 10
INSERT INTO principal (principal_name, external_id, remote_id, e_mail, account) VALUES ('Bob', '00000000-0000-0000-0000-000000000221', 'bob@mail.domain', 'Bob.Y@mail.domain', 'developer'); -- 11
...
INSERT INTO annotation (owner_id, headline,body_text, body_mimetype, external_id, last_modified, is_xml, public_) VALUES (3, 'Art Nuveau','some plain text', 'text/plain' , '00000000-0000-0000-0000-000000000023', '2013-08-12 11:30:00.383', false, 'all'); --3
...
INSERT INTO annotations_principals_accesses (annotation_id, principal_id, access_) VALUES (4, 1, 'all');
INSERT INTO annotations_principals_accesses (annotation_id, principal_id, access_) VALUES (4, 3, 'none');
INSERT INTO annotations_principals_accesses (annotation_id, principal_id, access_) VALUES (4, 11, 'none');
