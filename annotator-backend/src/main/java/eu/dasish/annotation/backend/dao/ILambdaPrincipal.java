...
public interface ILambdaPrincipal<Map, R> {
    ...
    /**
     * 
     * @param params list of pairs parameter -> value.
     * @return the object corresponding to the parameter values from the "params".
     * @throws NotInDataBaseException see the implementations.
     * @throws PrincipalExists  see the implementations
     */
